...
class PythonAnalyzer(LanguageAnalyzer):
    """
    Concrete implementation of LanguageAnalyzer for Python (PyPI) projects.
    Uses Python's ast module to extract internal structural metrics.
    """
    ...
    def analyze(
        ...
        meta = AnalysisMeta(
            ...
            edge_count=sum(1 for c in resolved_calls if c.call_type not in ("unresolved", "external", "dynamic")),
